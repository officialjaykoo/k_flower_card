...
const MESSAGES = {
  ko: {
    ...
    "board.gold": "골드",
    "board.point": "{value}점",
    "board.trace.turnNo": "최근 턴 #{value}",
    "board.trace.played": "낸 패",
    "board.trace.handMatch": "손패 맞춤",
    "board.trace.flip": "뒤집기",
    "board.trace.flipMatch": "뒤집기 맞춤",
    "board.trace.none": "-",
  ...
  en: {
    ...
    "board.trace.turnNo": "Recent turn #{value}",
    "board.trace.played": "Played",
    "board.trace.handMatch": "Hand match",
    "board.trace.flip": "Flip",
    "board.trace.flipMatch": "Flip match",
    "board.trace.none": "-",
