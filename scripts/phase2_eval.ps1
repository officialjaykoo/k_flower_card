# Pipeline Stage: Phase 2 Eval Wrapper
# Quick Read Map:
# 1) Load runtime + gate + winner genome
# 2) Build neat_eval_worker command
# 3) Execute 1000-game evaluation
...
Write-Host ""
Write-Host "=== Phase2 실전 결과 (Seed=$Seed) ==="
...
$passStatePath = Join-Path $outputDir "phase2_pass_state.json"
