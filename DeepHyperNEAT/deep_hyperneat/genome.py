...
def get_mutation_parameters():
	return {
		"node_add_prob": float(node_add_prob),
		"node_delete_prob": float(node_delete_prob),
		"conn_add_prob": float(conn_add_prob),
		"conn_delete_prob": float(conn_delete_prob),
		"weight_mutation_rate": float(weight_mutation_rate),
		"weight_mutation_power": float(weight_mutation_power),
		"inc_depth_prob": float(inc_depth_prob),
		"inc_breadth_prob": float(inc_breadth_prob),
	}


def configure_mutation_parameters(params=None):
	global node_add_prob
	global node_delete_prob
	global conn_add_prob
	global conn_delete_prob
	global weight_mutation_rate
	global weight_mutation_power
	global inc_depth_prob
	global inc_breadth_prob

	params = dict(params or {})
	defaults = get_mutation_parameters()

	node_add_prob = float(params.get("node_add_prob", defaults["node_add_prob"]))
	node_delete_prob = float(params.get("node_delete_prob", defaults["node_delete_prob"]))
	conn_add_prob = float(params.get("conn_add_prob", defaults["conn_add_prob"]))
	conn_delete_prob = float(params.get("conn_delete_prob", defaults["conn_delete_prob"]))
	weight_mutation_rate = float(params.get("weight_mutation_rate", defaults["weight_mutation_rate"]))
	weight_mutation_power = float(params.get("weight_mutation_power", defaults["weight_mutation_power"]))
	inc_depth_prob = float(params.get("inc_depth_prob", defaults["inc_depth_prob"]))
	inc_breadth_prob = float(params.get("inc_breadth_prob", defaults["inc_breadth_prob"]))
